...
return array(
  ...
  'package' => array(
    ...
    'changeLog' => array(
      '4.8.13' => array(
        'install/import/Ning/VideoVideos.php' => 'Added new pattern matching for new Vimeo URLs',
        'install/config/manifest.php' => 'Incremented version',
        'install/controllers/ImportController.php' => 'Improved Ning Import Process',
        'install/externals/images/socialengine_logo_admin.png' => 'Changed logo',
        'install/externals/styles/styles.css' => 'Improved Ning Import Process',
        'install/import/Abstract.php' => 'Improved Ning Import Process',
        'install/import/JsonAbstract.php' => 'Improved Ning Import Process',
        'install/import/Ning/*' => 'Improved Ning Import Process, Reintroduced php < 5.3 compatibility',
        'install/views/scripts/import/ning-instructions.tpl' => 'Improved Ning Import Process',
        'install/views/scripts/import/ning-split.tpl' => 'Improved Ning Import Process',
      ),
      '4.8.11' => array(
        'install/config/manifest.php' => 'Incremented version',
